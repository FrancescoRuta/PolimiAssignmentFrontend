...
@Component({
	selector: 'app-produzioni-in-corso',
	templateUrl: './produzioni-in-corso.component.html',
	styleUrls: ['./produzioni-in-corso.component.css']
})
export class ProduzioniInCorsoComponent implements OnInit {
	public filter: Filter = new Filter();
	
	@ViewChild("table")
	set table(table: TableComponent<Produzione, Filter>) {
		this.table_ = table;
		table.setApiGet(() => this.produzioneService.getProduzioniInCorso());
